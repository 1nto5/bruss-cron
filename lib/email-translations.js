...
export const OVERTIME_SUBMISSIONS = {
  subjects: {
    ...
    pendingSupervisorApproval: {
      PL: 'Zgłoszenia nadgodzin oczekujące na zatwierdzenie',
      EN: 'Overtime submissions awaiting approval',
      DE: 'Überstundenanträge warten auf Genehmigung',
    },
    pendingPlantManagerApproval: {
      PL: 'Zgłoszenia nadgodzin oczekujące na zatwierdzenie (wypłata)',
      EN: 'Overtime submissions awaiting approval (payout)',
      DE: 'Überstundenanträge warten auf Genehmigung (Auszahlung)',
    },
  },
  messages: {
    pendingSupervisorCount: (count) => {
      const safeCount = Number(count) || 0;
      return {
        PL: `Masz ${safeCount} ${safeCount === 1 ? 'zgłoszenie nadgodzin oczekujące' : 'zgłoszeń nadgodzin oczekujących'} na Twoje zatwierdzenie.`,
        EN: `You have ${safeCount} overtime submission${safeCount === 1 ? '' : 's'} awaiting your approval.`,
        DE: `Sie haben ${safeCount} Überstundenantrag${safeCount === 1 ? '' : 'santräge'}, der auf Ihre Genehmigung wartet.`,
      };
    },
    pendingPlantManagerCount: (count) => {
      const safeCount = Number(count) || 0;
      return {
        PL: `Masz ${safeCount} ${safeCount === 1 ? 'zgłoszenie nadgodzin (do wypłaty) oczekujące' : 'zgłoszeń nadgodzin (do wypłaty) oczekujących'} na Twoje zatwierdzenie.`,
        EN: `You have ${safeCount} overtime submission${safeCount === 1 ? '' : 's'} (payout) awaiting your approval.`,
        DE: `Sie haben ${safeCount} Überstundenantrag${safeCount === 1 ? '' : 'santräge'} (Auszahlung), der auf Ihre Genehmigung wartet.`,
      };
    },
